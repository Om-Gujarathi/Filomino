...
public class Board {
    ...
    public void enterBoard() {
        ...
        System.out.println("Entered Board is - ");
        printBoard();
    }
    ...
    //returns the minimum number of cells needed to complete a zone.
    ...
    // returns the number of cells that are either empty or changeable cells with incorrect values i.e the number of cells we need to work on
    ...
    //return the number of equal valued connected cells.
    ...
    // returns a list of boards, considers the values of its neighbors and creates a new board with each neighbor value as a potential fill for the empty cell.
    ...
    // returns true if that cell is empty and at-least one surrounding cell should be non - 0
    ...
    // returns all neighbors of a cell in a list
